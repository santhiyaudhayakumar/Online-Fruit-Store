...
import Plate from '../assets/fruit-plate.png'
    ...
    <section>
        <div className="container grid grid-cols-1 md:grid-cols-2 min-h-[650px] relative">
            ...
            <div className='flex flex-col justify-center py-14 md:py-0 relative z-10'>
                ...
                initial="hidden"
                animate="visible"
                className='text-5xl lg:text-6xl font-bold leading-relaxed xl:leading-loose font-averia'>Healthy<br />
                ...
                initial="hidden"
                animate="visible"
                className='text-2xl tracking-wide capitalize'>order now for fresh healthy life</motion.p>
                <motion.p
            ...
            <div className='flex justify-center items-center'>
                ...
                src={Plate} alt="Fruit plate" className='w-350px md:w-550px drop-shadow'/>
            </div>
